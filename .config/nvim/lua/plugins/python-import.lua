-- this plugins needs fd, which on ubuntu is called fd-find, so I think it is necessary to set up a symlink like this:
-- ln -s $(which fdfind) ~/.local/bin/fd
-- Also uv or pipx need to be installed. They can be installed with pip
return {
    {
